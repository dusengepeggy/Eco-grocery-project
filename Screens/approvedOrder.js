...
export default function Sucessful({navigation}) {

    return(
        <View style={{flex:1,justifyContent:'center',alignItems:'center',gap:15, backgroundColor:"white "}}>
            ...
            }} style={{width:"90%",padding:15,borderRadius:10,backgroundColor:'#FECB4C',alignItems:'center',justifyContent:'center'}}>
